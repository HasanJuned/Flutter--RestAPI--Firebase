...
import 'mutton_screen.dart';

class AddMuttonScreen extends StatefulWidget {
  const AddMuttonScreen({Key? key}) : super(key: key);

  @override
  State<AddMuttonScreen> createState() => _AddMuttonScreenState();
}

class _AddMuttonScreenState extends State<AddMuttonScreen> {
      ...
      builder: (context) {
        return AlertDialog(
          ...
          actions: [
            ...
            TextButton(
                onPressed: () async {
                  await FirebaseFirestore.instance.collection('mutton').add({
                  ...
                  AppElevatedButton(
                    ...
                    onTap: () async {
                      if (formKey.currentState!.validate()) {
                        ...
                        refereneceRoot.child('mutton_images');
